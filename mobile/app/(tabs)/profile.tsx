...
// adding as const so it prevent updating any field (Read-only)
            ...
            <View className="flex-row items-center">
              <View className="relative">
                <Image
                  ...
                  transition={200}
                />
                <View className="absolute -bottom-1 -right-1 bg-primary size-7 rounded-full items-center justify-center border-2 border-surface">
